...
public class MyGPSProvider implements IMyLocationProvider, LocationListener {
    ...
    public MyGPSProvider(Context context) {
    ...
    public void onLocationChanged(final Location location) {
        ...
        Log.d("myGps","onlocationchange"+location);
    }
